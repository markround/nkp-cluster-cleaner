...
![Version: 1.0.0-rc3](https://img.shields.io/badge/Version-1.0.0-rc3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0-rc3](https://img.shields.io/badge/AppVersion-1.0.0-rc3-informational?style=flat-square)
...
|-----|------|---------|-------------|
| deployment.image | string | `"ghcr.io/markround/nkp-cluster-cleaner:1.0.0-rc3"` | Container image to use |

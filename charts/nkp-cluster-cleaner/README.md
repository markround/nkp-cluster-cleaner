...
![Version: 0.13.13](https://img.shields.io/badge/Version-0.13.13-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.13.13](https://img.shields.io/badge/AppVersion-0.13.13-informational?style=flat-square)
...
|-----|------|---------|-------------|
| deployment.image | string | `"ghcr.io/markround/nkp-cluster-cleaner:0.13.13"` | Container image to use |

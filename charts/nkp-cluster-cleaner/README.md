...
![Version: 0.15.0-donotuse](https://img.shields.io/badge/Version-0.15.0-donotuse-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.15.0-donotuse](https://img.shields.io/badge/AppVersion-0.15.0-donotuse-informational?style=flat-square)
...
|-----|------|---------|-------------|
| deployment.image | string | `"ghcr.io/markround/nkp-cluster-cleaner:0.15.0-donotuse"` | Container image to use |

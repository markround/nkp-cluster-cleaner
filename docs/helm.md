...
```bash
helm install -n kommander nkp-cluster-cleaner mdr/nkp-cluster-cleaner --version 0.13.14
```
...
```bash
helm upgrade -n kommander nkp-cluster-cleaner mdr/nkp-cluster-cleaner --version 0.13.14
```

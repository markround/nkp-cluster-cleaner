...
```bash
helm install -n kommander nkp-cluster-cleaner mdr/nkp-cluster-cleaner --version 0.13.3
```
...
```bash
helm upgrade -n kommander nkp-cluster-cleaner mdr/nkp-cluster-cleaner --version 0.13.3
```

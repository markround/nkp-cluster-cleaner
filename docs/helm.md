...
```bash
helm -n kommander nkp-cluster-cleaner oci://ghcr.io/markround/helm/nkp-cluster-cleaner --version 1.0.0-rc1
```
...
```bash
helm install -n kommander nkp-cluster-cleaner mdr/nkp-cluster-cleaner --version 1.0.0-rc1
```
...
```bash
helm upgrade -n kommander nkp-cluster-cleaner mdr/nkp-cluster-cleaner --version 1.0.0-rc1
```
